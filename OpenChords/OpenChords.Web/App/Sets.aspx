...
<asp:Content ContentPlaceHolderID="MainForm" runat="server">
    ...
    <asp:Panel ID="pnlSetContents" Visible="false" runat="server" CssClass="Inline">
        <asp:Panel ID="pnlSongs" runat="server" CssClass="BoxPanel" GroupingText="Songs">
        ...
        <asp:Panel ID="pnlSongsInSet" runat="server" CssClass="BoxPanel" GroupingText="Songs In Set">
